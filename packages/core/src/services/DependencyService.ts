...
export class DependencyService {
   ...
   * Considers hierarchical dependency inheritance - both direct and inherited dependencies.
   *
   ...
   * Considers hierarchical inheritance - includes both direct and inherited dependencies.
   *
